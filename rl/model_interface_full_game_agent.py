...
def run(model_file):
    ...
    while keep_playing:
        ...
        whats_your_score = click.prompt("What is your score? ", type=int)
        whats_opponent_score = click.prompt("What is your opponent's score? ", type=int)
        ...
        observation["game_score_different"] = (
            121 - whats_your_score + whats_opponent_score
        )
