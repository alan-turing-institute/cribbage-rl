...
class Deck:
    """Deck of cards."""
    SUITS = {
        'hearts': {'name': 'hearts', 'symbol': '♥', 'unicode_flag': 'B', 'index': 0},
        'diamonds': {'name': 'diamonds', 'symbol': '♦', 'unicode_flag': 'C', 'index': 1},
        'clubs': {'name': 'clubs', 'symbol': '♣', 'unicode_flag': 'D', 'index': 2},
        'spades': {'name': 'spades', 'symbol': '♠', 'unicode_flag': 'A', 'index': 3}
    }
